...
export const categoryPromoSlides: Partial<Record<MainCategorySlug, PromoSlide[]>> = {
  ...
  toys: [
    ...
    { image: 'https://images.pexels.com/photos/207891/pexels-photo-207891.jpeg?auto=compress&cs=tinysrgb&w=1600', productId: 'ty-3' },
  ],
  electronics: [
    ...
    { image: 'https://images.pexels.com/photos/777001/pexels-photo-777001.jpeg?auto=compress&cs=tinysrgb&w=1600', productId: 'el-1' },
  ],
  aprons: [
